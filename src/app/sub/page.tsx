    ...
    <div className="w-full h-full flex items-center justify-center">
      ...
      <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-72 mx-2">
        <div className="z-0 order-1 md:order-2 relative w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg">
          <div className="absolute inset-0 w-full h-full bg-blue-400 bg-opacity-30 bg-cover bg-bottom bg-blend-multiply">
            <Image
              src={`${process.env.NEXT_PUBLIC_SUPABASE_URL!}${
                process.env.NEXT_PUBLIC_IMAGE_URL
              }${process.env.NEXT_PUBLIC_STORAGE_BUCKET}/Sub_Background.jpg`}
              alt=""
        ...
        <div className="z-2 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
