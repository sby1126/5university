  ...
  return (
    ...
    >
      <div className="gap-5 flex flex-col w-full max-w-[550px] p-5">
        ...
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Day and Night</span>, Rehall Art Gallery, Seoul, Korea</p>
          <p>August 2021</p>
          <p>Group exhibition of artists chosen by talent platform Leffica </p>
        </p>
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Threshold: Road to Utopia</span>, Chicago Korean Culture Center, Illinois, Chicago</p>
        ...
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Extinction and Creation</span>, Chicago Korean Culture Center, Illinois, Chicago</p>
          <p>September 2023 - December 2023</p>
          <p>Curated event as part of SAIC Korean Student Association’s Exhibition Branch. </p>
        </p>
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Veil: Between People</span>, Blue Cube Gallery, Seoul, Korea</p>
          <p>September 2024</p>
          <p>Solo Exhibition</p>
        </p>
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Beyond Border</span>, Group Art Show, Cosmos Gallery, New York, New York</p>
          <p>September 2024 - October 2024</p>
          <p>Group exhibition of artists chosen by Cosmos Gallery  </p>
        </p>
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Relationship, Veil, and Connections</span>, Vibe Art Space, Seoul, Korea</p>
          <p>November 2024</p>
          <p>Solo exhibition</p>
        </p>
        <p className="text-white text-[1rem]">
          <p><span className={`${kanit_it.className}`}>Undergraduate BFA Exhibition</span>, SAIC Gallery, Illinois, Chicago</p>
          <p>November 2024</p>
